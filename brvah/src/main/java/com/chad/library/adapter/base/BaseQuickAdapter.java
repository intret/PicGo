...
import static com.chad.library.BuildConfig.DEBUG;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public BaseQuickAdapter setDetectMoves(boolean detectMoves) {
        mDetectMoves = detectMoves;
        return this;
    }

    public DiffAsyncTask getDiffAsyncTask() {
        return mDiffAsyncTask;
    }

    public DiffUtilCallback<T> getDiffUtilCallback() {
