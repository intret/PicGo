...
public abstract class SectionedRecyclerViewAdapter<VH extends SectionedViewHolder>
    ...
    public void onBindHeaderViewHolder(VH holder, int section, boolean expanded, List<Object> payload) {
        onBindHeaderViewHolder(holder, section, expanded);
    }

    public abstract void onBindFooterViewHolder(VH holder, int section);

    public void onBindFooterViewHolder(VH holder, int section, List<Object> payload) {
        onBindViewHolder(holder, section);
    }
    ...
    public void onBindViewHolder(
            VH holder, int section, int relativePosition, int absolutePosition, List<Object> payload) {
