...
public class UserModule extends BaseModule {
     ...
     * UI preferences
     */
    public UserModule setMoveFileDialogFirstVisibleItemPosition(int moveFileDialogFirstVisibleItemPosition) {
     ...
     * Singleton
     */
    private static final UserModule ourInstance = new UserModule();
